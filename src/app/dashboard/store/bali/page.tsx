...
export default function StoreBaliPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6 flex items-center justify-center">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-3xl font-bold text-white mb-4">Bali Store</h1>
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-white/10 p-6 mb-6">
          <div className="flex items-center gap-3 text-slate-300 mb-4">
            <MapPin className="w-5 h-5 text-pink-400" />
            <span>Jl. Sunset Road No. 123, Seminyak</span>
          </div>
          <div className="flex items-center gap-3 text-slate-300">
            <Clock className="w-5 h-5 text-pink-400" />
            <span>09:00 - 21:00 WITA</span>
          </div>
        </div>
